...
namespace ImGui
{
    ...
    // @tacent Added IsAnyPopupOpen. Looks like this was added to ImGui proper above with flags.
    IMGUI_API bool          IsAnyPopupOpen();                                                   // return true if any popup is open at the current begin-ed level of the popup stack.
