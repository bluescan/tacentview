...
namespace ImGui
{
	...
	// @tacent-divergence Added arrowSizeOverride.
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0, float arrowSizeOverride = -1.0f);
